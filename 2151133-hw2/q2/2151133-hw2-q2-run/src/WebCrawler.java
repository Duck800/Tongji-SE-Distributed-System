...
public class WebCrawler {
    ...
    static String startSite="https://www.tongji.edu.cn";
    ...
    public static void getMaxInDegree(){
        ...
        list.sort((o1, o2) -> (o2.getValue() - o1.getValue()));//升序
        int maxInDegree=list.get(0).getValue();
        System.out.println(list.get(0).getKey()+"具有最大入度"+maxInDegree);

        for(int i=1;i<list.size();i++){
            if(list.get(i).getValue()==maxInDegree){
                System.out.println(list.get(i).getKey()+"具有最大入度"+maxInDegree);
            }
            else break;
        }
    }
